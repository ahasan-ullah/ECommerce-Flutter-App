...
class TTextTheme{
  ...
  static TextTheme lightTextTheme=TextTheme(
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.black.withValues(alpha: 0.5)),
  );
  static TextTheme darkTextTheme=TextTheme(
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.white.withValues(alpha: 0.5)),
  );
}